...
function Threepillors() {
  ...
  <Threepillorsimage/>
    <div>
      ...
      <div className="boxes">
        <div className="item_threepillor item1" id="firstrow">
        ...
        <div className="item_threepillor item1" id="firstrow2"><div className="btn-threepillor">Live Experience</div><br/><b>User Onboarding:</b><br/>Create a plan for guiding new users through your product's initial action.
        <br/>
            <br/>
        ...
        <div className="item_threepillor item2" id="secondrow"><div className="btn-threepillor">Live Experience</div><br/><b>Retention Design:</b><br/> How to entice new users to stay engaged with the product.
        <br/>
            <br/>
            <div>Case Studies Included</div>
            <img src="https://assets-global.website-files.com/63a49822ee2304acc9455a42/65f2c25f1510d6f571710eab_Ca-p-500.png" className="itemimg"/>
        ...
        <div className="item_threepillor item 2" id="secondrow2"><div className="btn-threepillor">Live Experience</div><br/><b>Revenue Generation</b><br/>
      ...
      <div className="next">
        <div className="item_threepillor" id="next1">
          <div className="btn-threepillor">Live Experience</div>
          <br />
        ...
        <div className="item_threepillor" id="next2"><div className="btn-threepillor">Proof of work</div><br/><b>Utilize the knowledge you have gained.</b><br/>
           <div className="video11"> Address practical issues in internet-first companies by using a capstone project and several smaller projects.</div>
           <img src="https://assets-global.website-files.com/63a49822ee2304acc9455a42/65f310f199de588be3bf89f9_capstone.png" className="itemimg"/>
        </div>
      </div>
      <Datavideopart/>
