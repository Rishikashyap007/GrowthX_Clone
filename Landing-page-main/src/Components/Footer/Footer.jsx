...
function Footer(){
  ...
  useEffect(() => {
    ...
    if(path === '/login' || path === '/register' || path === '/dashboard/home' || path === '/dashboard/help' || path === '/dashboard/application' || path === '/dashboard/limited-experience'){
      setHideFoot(true)
    }
    else {
      setHideFoot(false)
    ...
    return(
        ...
        {/* <h2 className="footer_first">Growth <span>X</span></h2> */}
          ...
          <img src={logo} alt="logo" height="70" loading="lazy" id="nav-logo" />
